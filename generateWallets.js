...
head -n 5 cdc_wallets.txt
head -n 5 cdc_wallets_thirdweb.csv
wc -l cdc_wallets.txthead -n 5 cdc_wallets.txt
head -n 5 cdc_wallets_thirdweb.csv
wc -l cdc_wallets.txt0
...
console.log('✅ CDC PUBLIC wallet registry generated (NO PRIVATE KEYS)');
