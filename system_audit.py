...
def run_audit():
    print("🔍 STARTING CDC SYSTEM AUDIT...\n")
    try:
        ...
        cur.execute("SELECT sum(cdc_reward) FROM rewards_schedule;")
        total_potential = cur.fetchone()[0]
        print(f"\n💰 REWARDS LOGIC: Total Potential CDC per Pioneer: {total_potential} CDC")
