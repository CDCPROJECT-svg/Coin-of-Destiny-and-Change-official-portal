...
def setup_youtube_auth():
    ...
    ACTION REQUIRED:
    To access the CDC Coin of Destiny & Change Portal, you must link your 
    YouTube Channel URL. 
    
    WHY:
    This URL serves as your Global Node ID. It allows the Blockchain Smart 
    Contract to recognize your Milestone Rewards (8 CDC, 4 CDC, etc.) 
    ...
    try:
        ...
        print("✅ SECURITY: One YouTube URL = One CDC Member ID.")
        print("✅ REWARD READY: Blockchain can now auto-scan for 51 CDC.")
        print("--------------------------------------------------")
